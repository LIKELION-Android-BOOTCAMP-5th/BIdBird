...
class ItemRegistrationTerms {
  ...
  /// 가격 관련 약관
  static const String priceTerms = 
      '1. 판매자는 시작가를 정확하게 입력해야 합니다. 허위 정보 입력은 금지됩니다.\n'
      '2. 시작가는 1,000원부터 1,000만원까지 설정 가능합니다.\n'
      '3. 낙찰 금액은 플랫폼 정책에 따라 결제·정산 절차가 진행됩니다. 판매자는 이에 동의한 것으로 간주됩니다.\n'
      '4. 경매 기간 중 가격 조정은 불가능하니 신중하게 설정해주세요.';
}
