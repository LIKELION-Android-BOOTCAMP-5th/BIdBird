...
import 'package:bidbird/core/widgets/item/bid/buy_now/buy_now_header.dart';
import 'package:bidbird/core/widgets/item/bid/buy_now/buy_now_price_card.dart';
import 'package:bidbird/core/widgets/item/bid/buy_now/buy_now_primary_button.dart';
              ...
              onPressed: () async {
                ...
                try {
                  ...
                  if (isBlocked) {
                    messenger.showSnackBar(
                      const SnackBar(
                        content: Text(BidErrorMessages.bidRestricted),
                      ),
                    );
                    return;
                  }
                  ...
                  messenger.showSnackBar(
                    SnackBar(
                      content: Text(BidErrorMessages.bidRestrictionCheckFailed(e)),
                    ),
                  );
                  return;
                }
