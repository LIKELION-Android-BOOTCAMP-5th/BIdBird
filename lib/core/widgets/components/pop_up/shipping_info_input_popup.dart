...
class _ShippingInfoInputPopupState extends State<ShippingInfoInputPopup> {
  ...
  void _checkFormValidity() {
    ...
    final trackingNumberValid = _hasExistingData 
        ? (widget.initialTrackingNumber != null && widget.initialTrackingNumber!.isNotEmpty)
              ...
              children: [
                ...
                Row(
                  ...
                  controller: _trackingNumberController,
                        enabled: _isEditing && !_hasExistingData && !_isDirectTrade, // 기존 송장 번호가 있으면 수정 불가, 직거래 모드일 때도 비활성화
                  decoration: InputDecoration(
                    ...
                    border: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(8),
                            borderSide: BorderSide(
                              color: (_isEditing && !_hasExistingData && !_isDirectTrade) ? blueColor : Colors.grey.shade300,
                            ),
                    ),
                    enabledBorder: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(8),
                    ...
                    filled: true,
                          fillColor: (_isEditing && !_hasExistingData && !_isDirectTrade) ? Colors.white : Colors.grey.shade50,
                  ),
                      ),
                    ),
